...
namespace KrishiLink.DAL.Migrations
{
    ...
    [Migration("20260925144135_AddCommunityHub")]
    partial class AddCommunityHub
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KrishiLink.Models.Entities.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("PreferredLandUnit")
                        .HasMaxLength(10)
            ...
            modelBuilder.Entity("KrishiLink.Models.Entities.CommunityBookmark", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("CommunityBookmarks", "krishilink");
                });

            modelBuilder.Entity("KrishiLink.Models.Entities.CommunityComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("CommunityComments", "krishilink");
                });

            modelBuilder.Entity("KrishiLink.Models.Entities.CommunityPost", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("CommunityPosts", "krishilink");
                });

            modelBuilder.Entity("KrishiLink.Models.Entities.CommunityPostReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("CommunityPostReports", "krishilink");
                });

            modelBuilder.Entity("KrishiLink.Models.Entities.CommunityReaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("CommunityReactions", "krishilink");
                });
            ...
            modelBuilder.Entity("KrishiLink.Models.Entities.EmailDeliveryLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex("RecipientHash", "AttemptedAt");

                    b.HasIndex("UserId", "AttemptedAt");

                    b.ToTable("EmailDeliveryLogs", "krishilink");
                });
            ...
            modelBuilder.Entity("KrishiLink.Models.Entities.PostMedia", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("PostMedia", "krishilink");
                });
            ...
            modelBuilder.Entity("KrishiLink.Models.Entities.SeasonCost", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("SeasonCosts", "krishilink");
                });
            ...
            modelBuilder.Entity("KrishiLink.Models.Entities.CommunityBookmark", b =>
                {
                    b.HasOne("KrishiLink.Models.Entities.CommunityPost", "Post")
                        .WithMany("Bookmarks")
            ...
            modelBuilder.Entity("KrishiLink.Models.Entities.CommunityComment", b =>
                {
                    b.HasOne("KrishiLink.Models.Entities.ApplicationUser", "Author")
                        .WithMany()
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("KrishiLink.Models.Entities.CommunityComment", "ParentComment")
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("KrishiLink.Models.Entities.CommunityPost", b =>
                {
                    b.HasOne("KrishiLink.Models.Entities.CommunityComment", "AcceptedComment")
                        .WithMany()
            ...
            modelBuilder.Entity("KrishiLink.Models.Entities.CommunityPostReport", b =>
                {
                    ...
                    b.HasOne("KrishiLink.Models.Entities.ApplicationUser", "Reporter")
                        .WithMany()
            ...
            modelBuilder.Entity("KrishiLink.Models.Entities.CommunityReaction", b =>
                {
                    b.HasOne("KrishiLink.Models.Entities.CommunityComment", "Comment")
                        .WithMany("Reactions")
            ...
            modelBuilder.Entity("KrishiLink.Models.Entities.HarvestPlan", b =>
                {
                    b.HasOne("KrishiLink.Models.Entities.CropCalendarEntry", "CropEntry")
                        .WithMany()
